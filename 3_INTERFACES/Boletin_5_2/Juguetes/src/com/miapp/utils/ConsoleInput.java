...
public class ConsoleInput {
    ...
    public static int seleccionarOpcion(String mensaje, String[] opciones) {
        ...
        while (flag) {
            ...
            opcionElegida = ConsoleInput.solicitarEnteroEnRango(mensaje, 1, opciones.length);
            flag = false;
        }
    ...
    /*Agregando una función para que me devuelva la fecha al formato Español*/



        // Lista de formatos de fecha que se intentarán parsear
    ...
    public static LocalDate solicitarFecha(String mensaje) {
        ...
        String fechaStr = sc.nextLine(); // Leer la fecha que ingresa el usuario

        // Intentar parsear la fecha en cada uno de los formatos
        for (DateTimeFormatter formatter : FORMATOS_FECHA) {
            try {
                return LocalDate.parse(fechaStr, formatter);
            } catch (DateTimeParseException e) {
                // Si no se puede parsear con este formato, continuar con el siguiente
            }
        }

        // Si no se pudo parsear la fecha en ninguno de los formatos, lanzar una excepción
